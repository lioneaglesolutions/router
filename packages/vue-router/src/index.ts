...
export type SyncRouteComponent<TProps> =
  | ((props: TProps) => VueComponent)
  | Vue.Component<(props: TProps) => VueComponent>
...
>(
  ...
  const lazyComp = Vue.defineAsyncComponent(async () => {
...
> = LinkOptions<RegisteredRoutesInfo, TFrom, TTo> & {
  ...
  activeProps?: Vue.AnchorHTMLAttributes | (() => Vue.AnchorHTMLAttributes)
  // A function that returns additional props for the `inactive` state of this link. These props override other props passed to the link (`style`'s are merged, `className`'s are concatenated)
  inactiveProps?: Vue.AnchorHTMLAttributes | (() => Vue.AnchorHTMLAttributes)
...
export type MakeLinkPropsOptions<
  ...
  TTo extends string = '',
> = LinkPropsOptions<TFrom, TTo> & Vue.AnchorHTMLAttributes

export type MakeLinkOptions<
  TFrom extends RegisteredRoutesInfo['routePaths'] = '/',
  TTo extends string = '',
> = LinkPropsOptions<TFrom, TTo> &
  Omit<Vue.AnchorHTMLAttributes, 'children'> & {
    // If a function is passed as a child, it will be given the `isActive` boolean to aid in further styling on the element it returns
    children?: VueComponent | ((state: { isActive: boolean }) => VueComponent)
  }
...
export function useLinkProps<
  TFrom extends string = '/',
  TTo extends string = '',
>(options: MakeLinkPropsOptions<TFrom, TTo>): Vue.AnchorHTMLAttributes {
  ...
  const resolvedActiveProps: Vue.HTMLAttributes = isActive
    ? functionalUpdate(activeProps as any, {}) ?? {}
    : {}

  // Get the inactive props
  const resolvedInactiveProps: Vue.HTMLAttributes = isActive
    ? {}
...
export const Link: LinkComponent = Vue.defineComponent({
  props: {
    to: String,
    // Other link-related props
  },
  setup(props, { attrs }) {
    const to = Vue.ref(props.to)
    ...
    const isActive = Vue.computed(() => {
      return attrs['data-status'] === 'active'
    })

    const handleClick = (event: Event) => {
      // Handle click event if needed
      // You can also call emit('click', event) if you want to emit a custom event
    }
...
export function _RouterProvider<
  TRouteConfig extends AnyRoute = AnyRoute,
  TRoutesInfo extends AnyRoutesInfo = DefaultRoutesInfo,
  TDehydrated extends Record<string, any> = Record<string, any>,
...
//   return (children ?? null) as VueComponent
// }
